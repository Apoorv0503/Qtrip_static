...
![Landing_Page](https://drive.google.com/uc?export=view&id=1Rv9V44qyjueihZoCBDbZaWPlgS1BmVyF)
...
![Adventures_Grid_Page](https://drive.google.com/uc?export=view&id=1RBS1Hh2eOP2E2pK1wKnso5kY8cXbyWVi)
...
![Adventure_Details_Page](https://drive.google.com/uc?export=view&id=1Nkknlg8eLRXzSbwvOgSaKfRAVP5TA8Bk)

## Overview:
The focus of this project is to use HTML, CSS and Bootstrap skills to create a Frontend website. QTrip has this travel website where users can browse the various Adventures on offer, based on their places of interest and book an Adventure.
